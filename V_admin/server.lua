...
RegisterServerEvent("vtx:GiveCash")
AddEventHandler("vtx:GiveCash", function(money)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local total = money
...
RegisterServerEvent("vtx:GiveBanque")
AddEventHandler("vtx:GiveBanque", function(money)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local total = money
...
RegisterServerEvent("vtx:GiveND")
AddEventHandler("vtx:GiveND", function(money)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local total = money
